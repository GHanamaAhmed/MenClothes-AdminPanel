"use client";
import { MagnifyingGlassIcon, PlusIcon, ReceiptPercentIcon, TrashIcon } from "@heroicons/react/24/outline";
import {
  PencilIcon,
  PencilSquareIcon,
  UserPlusIcon,
		...
		<>
			...
			<Dialog open={open} handler={handleOpen} size="xl">
				<DialogHeader className="font-Hacen-Tunisia flex flex-row items-center justify-between gap-2">
					<p>المنتج</p>
					<Switch label={`${value? 'اظهار المنتج':'اخفاء المنتج' }`} labelProps={{className: "text-gray-400 mx-2 text-right"}}  onChange={handlevalue}/>
				</DialogHeader>
